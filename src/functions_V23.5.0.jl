...
function DAQmxCreateAIPowerChan(taskHandle, physicalChannel, nameToAssignToChannel, voltageSetpoint, currentSetpoint, outputEnable)
    ccall((:DAQmxCreateAIPowerChan, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, float64, float64, bool32), taskHandle, physicalChannel, nameToAssignToChannel, voltageSetpoint, currentSetpoint, outputEnable)
end
...
function DAQmxSetup15110Cal(calHandle, channelNames, value)
    ccall((:DAQmxSetup15110Cal, NIDAQmx), int32, (CalHandle, Ptr{UInt8}, int32), calHandle, channelNames, value)
end

function DAQmxAdjust15110Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust15110Cal, NIDAQmx), int32, (CalHandle, Ptr{UInt8}, float64), calHandle, channelNames, value)
end
...
function DAQmxSetup15200Cal(calHandle, channelNames, adjustmentPoint, powerCalibrationType)
    ccall((:DAQmxSetup15200Cal, NIDAQmx), int32, (CalHandle, Ptr{UInt8}, float64, int32), calHandle, channelNames, adjustmentPoint, powerCalibrationType)
end

function DAQmxAdjust15200Cal(calHandle, channelNames, referenceValue, powerCalibrationType)
    ccall((:DAQmxAdjust15200Cal, NIDAQmx), int32, (CalHandle, Ptr{UInt8}, float64, int32), calHandle, channelNames, referenceValue, powerCalibrationType)
end
...
function DAQmxGetCICountEdgesGateTerm(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCICountEdgesGateTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCICountEdgesGateTerm(taskHandle, channel, data)
    ccall((:DAQmxSetCICountEdgesGateTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCICountEdgesGateDigFltrTimebaseSrc(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCICountEdgesGateDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCICountEdgesGateDigFltrTimebaseSrc(taskHandle, channel, data)
    ccall((:DAQmxSetCICountEdgesGateDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIDutyCycleTerm(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIDutyCycleTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIDutyCycleTerm(taskHandle, channel, data)
    ccall((:DAQmxSetCIDutyCycleTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIDutyCycleDigFltrTimebaseSrc(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIDutyCycleDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIDutyCycleDigFltrTimebaseSrc(taskHandle, channel, data)
    ccall((:DAQmxSetCIDutyCycleDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIVelocityEncoderAInputTerm(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIVelocityEncoderAInputTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIVelocityEncoderAInputTerm(taskHandle, channel, data)
    ccall((:DAQmxSetCIVelocityEncoderAInputTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIVelocityEncoderAInputDigFltrTimebaseSrc(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIVelocityEncoderAInputDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIVelocityEncoderAInputDigFltrTimebaseSrc(taskHandle, channel, data)
    ccall((:DAQmxSetCIVelocityEncoderAInputDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIVelocityEncoderBInputTerm(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIVelocityEncoderBInputTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIVelocityEncoderBInputTerm(taskHandle, channel, data)
    ccall((:DAQmxSetCIVelocityEncoderBInputTerm, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetCIVelocityEncoderBInputDigFltrTimebaseSrc(taskHandle, channel, data, bufferSize)
    ccall((:DAQmxGetCIVelocityEncoderBInputDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}, uInt32), taskHandle, channel, data, bufferSize)
end

function DAQmxSetCIVelocityEncoderBInputDigFltrTimebaseSrc(taskHandle, channel, data)
    ccall((:DAQmxSetCIVelocityEncoderBInputDigFltrTimebaseSrc, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{UInt8}), taskHandle, channel, data)
end
...
function DAQmxGetPwrVoltageSetpoint(taskHandle, channel, data)
    ccall((:DAQmxGetPwrVoltageSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{float64}), taskHandle, channel, data)
end

function DAQmxSetPwrVoltageSetpoint(taskHandle, channel, data)
    ccall((:DAQmxSetPwrVoltageSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, float64), taskHandle, channel, data)
end

function DAQmxResetPwrVoltageSetpoint(taskHandle, channel)
    ccall((:DAQmxResetPwrVoltageSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, channel)
end

function DAQmxGetPwrVoltageDevScalingCoeff(taskHandle, channel, data, arraySizeInElements)
    ccall((:DAQmxGetPwrVoltageDevScalingCoeff, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{float64}, uInt32), taskHandle, channel, data, arraySizeInElements)
end

function DAQmxGetPwrCurrentSetpoint(taskHandle, channel, data)
    ccall((:DAQmxGetPwrCurrentSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{float64}), taskHandle, channel, data)
end

function DAQmxSetPwrCurrentSetpoint(taskHandle, channel, data)
    ccall((:DAQmxSetPwrCurrentSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, float64), taskHandle, channel, data)
end

function DAQmxResetPwrCurrentSetpoint(taskHandle, channel)
    ccall((:DAQmxResetPwrCurrentSetpoint, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, channel)
end

function DAQmxGetPwrCurrentDevScalingCoeff(taskHandle, channel, data, arraySizeInElements)
    ccall((:DAQmxGetPwrCurrentDevScalingCoeff, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{float64}, uInt32), taskHandle, channel, data, arraySizeInElements)
end

function DAQmxGetPwrOutputEnable(taskHandle, channel, data)
    ccall((:DAQmxGetPwrOutputEnable, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{bool32}), taskHandle, channel, data)
end

function DAQmxSetPwrOutputEnable(taskHandle, channel, data)
    ccall((:DAQmxSetPwrOutputEnable, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, bool32), taskHandle, channel, data)
end

function DAQmxResetPwrOutputEnable(taskHandle, channel)
    ccall((:DAQmxResetPwrOutputEnable, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, channel)
end

function DAQmxGetPwrOutputState(taskHandle, channel, data)
    ccall((:DAQmxGetPwrOutputState, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{int32}), taskHandle, channel, data)
end

function DAQmxGetPwrIdleOutputBehavior(taskHandle, channel, data)
    ccall((:DAQmxGetPwrIdleOutputBehavior, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{int32}), taskHandle, channel, data)
end

function DAQmxSetPwrIdleOutputBehavior(taskHandle, channel, data)
    ccall((:DAQmxSetPwrIdleOutputBehavior, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, int32), taskHandle, channel, data)
end

function DAQmxResetPwrIdleOutputBehavior(taskHandle, channel)
    ccall((:DAQmxResetPwrIdleOutputBehavior, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, channel)
end

function DAQmxGetPwrRemoteSense(taskHandle, channel, data)
    ccall((:DAQmxGetPwrRemoteSense, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, Ptr{int32}), taskHandle, channel, data)
end

function DAQmxSetPwrRemoteSense(taskHandle, channel, data)
    ccall((:DAQmxSetPwrRemoteSense, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, int32), taskHandle, channel, data)
end

function DAQmxResetPwrRemoteSense(taskHandle, channel)
    ccall((:DAQmxResetPwrRemoteSense, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, channel)
end
...
function DAQmxGetFieldDAQDevName(device, data, bufferSize)
    ccall((:DAQmxGetFieldDAQDevName, NIDAQmx), int32, (Ptr{UInt8}, Ptr{UInt8}, uInt32), device, data, bufferSize)
end

function DAQmxGetFieldDAQBankDevNames(device, data, bufferSize)
    ccall((:DAQmxGetFieldDAQBankDevNames, NIDAQmx), int32, (Ptr{UInt8}, Ptr{UInt8}, uInt32), device, data, bufferSize)
end
...
function DAQmxGetDevCompactRIOChassisDevName(device, data, bufferSize)
    ccall((:DAQmxGetDevCompactRIOChassisDevName, NIDAQmx), int32, (Ptr{UInt8}, Ptr{UInt8}, uInt32), device, data, bufferSize)
end
...
function DAQmxGetReadOpenChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadOpenChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end

function DAQmxGetReadOpenChansDetails(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadOpenChansDetails, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetReadInputLimitsFaultChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadInputLimitsFaultChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetReadPLLUnlockedChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadPLLUnlockedChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetReadPowerSupplyFaultChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadPowerSupplyFaultChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetReadSyncUnlockedChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReadSyncUnlockedChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetRemoteSenseErrorChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetRemoteSenseErrorChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetAuxPowerErrorChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetAuxPowerErrorChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetReverseVoltageErrorChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetReverseVoltageErrorChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetAnlgMultiEdgeStartTrigSrcs(taskHandle, data, bufferSize)
    ccall((:DAQmxGetAnlgMultiEdgeStartTrigSrcs, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end

function DAQmxSetAnlgMultiEdgeStartTrigSrcs(taskHandle, data)
    ccall((:DAQmxSetAnlgMultiEdgeStartTrigSrcs, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, data)
end
...
function DAQmxGetAnlgMultiEdgeRefTrigSrcs(taskHandle, data, bufferSize)
    ccall((:DAQmxGetAnlgMultiEdgeRefTrigSrcs, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end

function DAQmxSetAnlgMultiEdgeRefTrigSrcs(taskHandle, data)
    ccall((:DAQmxSetAnlgMultiEdgeRefTrigSrcs, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}), taskHandle, data)
end
...
function DAQmxGetWriteExternalOvervoltageChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetWriteExternalOvervoltageChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
...
function DAQmxGetWriteSyncUnlockedChans(taskHandle, data, bufferSize)
    ccall((:DAQmxGetWriteSyncUnlockedChans, NIDAQmx), int32, (TaskHandle, Ptr{UInt8}, uInt32), taskHandle, data, bufferSize)
end
